...
public class WordCountJob implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		MultipleOutputs.addNamedOutput(wordCountJob, "EVEN", TextOutputFormat.class, Text.class, LongWritable.class);
		MultipleOutputs.addNamedOutput(wordCountJob, "ODD", TextOutputFormat.class, Text.class, LongWritable.class);
