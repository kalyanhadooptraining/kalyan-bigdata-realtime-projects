...
public class InvertedIndexingJob implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		wordCountJob.setMapperClass(InvertedIndexingMapper.class);

		// setting custom reducer class
		wordCountJob.setReducerClass(InvertedIndexingReducer.class);
		...
		wordCountJob.setInputFormatClass(SequenceFileInputFormat.class);
